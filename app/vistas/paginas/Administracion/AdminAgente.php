                ...
                <div class="col-12">
                    ...
                    <div class="bg-holder d-none d-md-block bg-card"></div>
                        <div class="position-relative z-index-2">
                            <div>
                                <h3 class="mb-1">Hola, <span id="_Nombre"></span>!</h3>
                                <p>¿Qué hago ahora?</p>
                            </div>
                            
                            <div class="card border h-100 custom-card-border mb-3">
                                <div class="card-header">
                                    <a href="<?php echo constant('RUTA_URL');?>/tomartarea" style="text-decoration: none;">
                                        <div class="row">
                                            ...
                                            <div class="col-10">
                                                <div class="media-body position-relative pl-3">
                                                    <h5 class="mb-0">Toma una tarea</h5>
                                                    <p class="fs--1">Haz click acá y selecciona una tarea que esté disponible.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                            ...
                            <div class="alert alert-danger border-2 d-flex align-items-center" role="alert">
                                ...
                                <p class="mb-0 flex-1 fs--2">Si fuiste asignado directamente a una tarea, podrás omitir este paso. Recuerda realizar tu tarea durante el tiempo que tengas asignado.</p>
                            </div>
                            ...
                            <div class="card border h-100 custom-card-border mb-3">
                                <div class="card-header">
                                    <a href="<?php echo constant('RUTA_URL');?>/tareasasignadas" style="text-decoration: none;">
                                        <div class="row">
                                            <div class="col-2 d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="col-10">
                                                <div class="media-body position-relative pl-3">
                                                    ...
                                                    <p class="fs--1">Haz click acá y visualiza las tareas a las que fuiste asignado(a) directamente por tu jefatura.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                            ...
                            <div class="card border h-100 custom-card-border mb-3">
                                <div class="card-header">
                                    <a href="<?php echo constant('RUTA_URL');?>/tareasencurso" style="text-decoration: none;">
                                        <div class="row">
                                            <div class="col-2 d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="col-10">
                                                <div class="media-body position-relative pl-3">
                                                    ...
                                                    <p class="fs--1">Haz click acá y visualiza las tareas que están en curso (que debes ejecutar o estás ejecutando).</p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                            ...
                            <div class="card border h-100 custom-card-border mb-3">
                                <div class="card-header">
                                    <a href="<?php echo constant('RUTA_URL');?>/tareasfinalizadas" style="text-decoration: none;">
                                        <div class="row">
                                            <div class="col-2 d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="col-10">
                                                <div class="media-body position-relative pl-3">
                                                    <h5 class="mb-0">Tareas finalizadas</h5>
                                                    <p class="fs--1">Haz click acá y visualiza las tareas que se encuentran finalizadas, así como su estado (aprobadas o no).</p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
