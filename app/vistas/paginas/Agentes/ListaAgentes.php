...
<div class="content">
            ...
            <div class="row">
                <div class="col-md-auto">
                    <a class="btn btn-outline-primary btn-sm me-1 mb-1"
                       href="<?php echo constant('RUTA_URL');?>/agentes/0">
    ...
    <div class="card mb-3">
        ...
        <p class="fs--1">Agentes: Son todas las personas disponibles en sistema para realizar tareas creadas por administradores o clientes</p>
        </div> 
    </div>
</div>
...
<script>
    $(document).ready(function ()
    {
        ...
        var table = $('#Lista').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "<?php echo constant('RUTA_REST');?>/rest-api/Agentes?dtagentesGET="+<?php echo $empresaID; ?>,
            columns: [
                { "title": "ID" },
                { "title": "Nombre" },                
                { "title": "Dirección" },
            ...
            language: {
                ...
                "info": "Viendo _START_ a _END_ de _TOTAL_ agentes",
                "infoEmpty": "Viendo 0 to 0 of 0 agentes",
                "infoFiltered": "(Filtrado de _MAX_ total agentes)",
                "infoPostFix": "",
                "thousands": ",",
                "lengthMenu": "Ver _MENU_ agentes",
    ...
    function EliminarUsuario(id) {
        ...
        Swal.fire({
            title                 : '<strong>Eliminar el Agente?</strong>',
            icon                  : 'info',
            html                  : 'Se eliminara el Agente y todos sus datos!',
            ...
            if (result.value) {
                var apiUrl='<?php echo constant('RUTA_REST'); ?>/rest-api/Agentes'; 
                var data = { 
                    userID    : id, 
                    usuarioID : usuarioID 
                } 
    ...
    function EditarForm(id){
        window.location = "<?php echo constant('RUTA_URL');?>/agentes/"+id;
    }
