    ...
    <?php  if($clienteID > 0){?> 
        <div class="card mb-3">
            <div class="card-header">
                ...
                <small>Asociadas por adminstración a su cuenta</small>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
      ...
      <div class="container py-2">
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="card-header">
                        <h4>Agregar | Cambiar foto de perfil.</h4>
                        <small>Esta foto sera visible en las busquedas y en tu perfil</small>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="profile-image" class="form-label">Seleccionar Foto</label>
...
<script>
    ...
    function FotoPefil() {
        ...
        var apiUrl='<?php echo constant('RUTA_URL'); ?>/rest-api/AgentesFotoPerfil.php'; 
        var data = {
            clienteID : clienteID,
            Foto      : Foto
        }; 
