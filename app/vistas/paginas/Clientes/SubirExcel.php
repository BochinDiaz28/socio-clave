                ...
                <div class="card text-center">
                    ...
                    <div class="card-footer">
                        ...
                        <a class="btn btn-outline-secondary btn-sm me-1 mb-1" 
                           type="button"
                           download
                           href="<?php echo constant('RUTA_URL');?>/rest-api/tmpExcel/Ejemplo-Lista.xlsx">                            
                            <span class="fas fa-cloud-download-alt mr-1" data-fa-transform="shrink-3"></span>
                            <span class="text">Descargar Ejemplo</span>
                        </a>
                        <p class="fs--1">Para un correcto envio de la información, descargue la planilla de ejemplo.</p>
...
<script>
    $(document).ready(function()
    {
        $(".upload2").on('click', function() {
            ...
            $.ajax({
                url: "<?php echo constant('RUTA_URL');?>/rest-api/tmpExcel/UploadListaRetail.php",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
    ...
    function  ActualizarLista(Archivo,UserId)
    {
        ...
        var ruta="<?php echo constant('RUTA_URL');?>/rest-api/UploadListaRetail.php";
        fetch(ruta,{ 
            method : 'POST',  
        ...
        .then(data => {
            ...
            if(data[0]["error"]){
                ...
                Swal.fire({
                    type             : 'success',
                    icon             : 'success',
                    title            : 'Sucursales Nuevas: '+ Ingresados +'<br> Existentes: ' +Existentes,
                    showConfirmButton: false,
                    timer            : 2000
                })
