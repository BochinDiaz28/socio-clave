                ...
                <div class="card text-center">
                    <div class="card-header">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <small>Seleccione el cliente, para subir el inventario</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="card-footer">
                        ...
                        <a class="btn btn-outline-secondary btn-sm me-1 mb-1" 
                           type="button"
                           download
                           href="<?php echo constant('RUTA_URL');?>/rest-api/tmpExcel/Ejemplo-Lista-Panol.xlsx">                            
...
<script>
    ...
    $(document).ready(function()
    {
        ...
        $(".upload2").on('click', function() {
            ...
            $.ajax({
                url: "<?php echo constant('RUTA_URL');?>/rest-api/tmpExcel/UploadListaPanol.php",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
    ...
    function  ActualizarLista(Archivo,UserId)
    {
        ...
        var ruta="<?php echo constant('RUTA_URL');?>/rest-api/UploadListaPanol.php";
        fetch(ruta,{ 
            method : 'POST',  
        ...
        .then(data => {
            ...
            if(data[0]["error"]){
                ...
                Swal.fire({
                    type             : 'success',
                    icon             : 'success',
                    title            : 'Productos<br> Nuevos: '+ Ingresados +'<br> Existentes: ' +Existentes,
                    showConfirmButton: false,
                    timer            : 2000
                })
