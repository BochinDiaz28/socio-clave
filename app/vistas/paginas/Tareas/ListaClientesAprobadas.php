...
<script>
    ...
    function Grilla(clienteID) {
        ...
        var table = $('#Lista').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax"      : "<?php echo constant('RUTA_REST');?>/rest-api/Tareas?dttrscliaprobadasGET="+<?php echo $empresaID; ?>+"&solicita1GET="+clienteID,
            columns: [
                { "title": "ID" },
                { "title": "Tarea" },                
                { "title": "Sucursal" },
            ...
            language: {
                ...
                "info": "Viendo _START_ a _END_ de _TOTAL_ t. aprobadas",
                "infoEmpty": "Viendo 0 to 0 of 0 t. aprobadas",
                "infoFiltered": "(Filtrado de _MAX_ total t. aprobadas)",
                "infoPostFix": "",
                "thousands": ",",
