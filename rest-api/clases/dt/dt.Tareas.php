...
$table = <<<EOT
(
    SELECT a.id, a.idempresa, a.idcliente, b.nombre AS nombreC, a.idreail, a.tarea, a.sucursal, a.ubicacion, a.fecha_alta, a.fecha_sol, a.hora_inicio, a.hora_final, a.estado, a.idagente
    FROM tareas a
    INNER JOIN clientes b ON a.idcliente = b.id
    INNER JOIN retail c ON a.idreail = c.id
