...
$asunto = "Envio entregado por ".$nombrePro;
$cuerpo = '<!DOCTYPE html>
              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">Hola entregamos tu paquete!!.</h1>
                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                      Tu envio con Full delivery express fue entregado!.<br>
                    </p>
                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                      Dirección de Entrega: <b>'.$calleD.'</b>
                    </p>
...
$nombre  = "Envio entregado por ".$nombrePro;
$mensaje = $cuerpo;
...
$mail->FromName = "FDE";
$mail->AddAddress($emailOrigen); // Esta es la dirección a donde enviamos los datos del formulario
